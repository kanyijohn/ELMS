...
if (strlen($_SESSION['emplogin']) == 0) {
    ...
    if (isset($_POST['apply'])) {
        ...
        if ($fromdate > $todate) {
            ...
            if ($lastInsertId) {
                // Fetch supervisor email and notify
                $sql = "SELECT s.EmailId, s.FirstName, s.LastName FROM tblemployees e 
                ...
                if ($supervisor) {
                    $to = $supervisor->EmailId;
                    $subject = "Leave Request Notification";
                    $message = "Dear " . $supervisor->FirstName . " " . $supervisor->LastName . ",\n\n"
