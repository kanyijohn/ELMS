...
session_start();
error_reporting(0);
include '../includes/config.php'; // use correct path since includes is outside supervisor
...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Responsive Employee Dashboard" />
    <meta name="keywords" content="employee,dashboard" />
    <meta name="author" content="Steelcoders" />

    <!-- Styles (absolute paths) -->
    <link type="text/css" rel="stylesheet" href="/elms/assets/plugins/materialize/css/materialize.min.css"/>
    <link type="text/css" rel="stylesheet" href="/elms/assets/plugins/materialize/css/materialize.css"/>
    <link href="http://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link href="/elms/assets/plugins/material-preloader/css/materialPreloader.min.css" rel="stylesheet">
    <link href="/elms/assets/css/alpha.min.css" rel="stylesheet" type="text/css"/>
    <link href="/elms/assets/css/custom.css" rel="stylesheet" type="text/css"/>
    <link href="/elms/assets/css/style.css" rel="stylesheet" type="text/css"/>
