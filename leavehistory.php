                            ...
                            <table id="example" class="display responsive-table ">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="color: red;">Admin Issue Status</th> <!-- ✅ NEW -->
                                    </tr>
                                </thead>
...
<?php
$eid = $_SESSION['eid'];
$sql = "SELECT LeaveType,ToDate,FromDate,Description,PostingDate,AdminRemarkDate,AdminRemark,Status,Issued 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($result->AdminRemark == "") {
                                                ...
                                                echo htmlentities($result->AdminRemark) . " at " . htmlentities($result->AdminRemarkDate);
                                            } ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php 
                                            if ($result->Issued == 1) {
                                                echo "<span style='color: green'>Issued</span>";
                                            } elseif ($result->Issued == 2) {
